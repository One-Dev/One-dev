...
class Sucursal {
    ...
    static function AgregarSucursal($IdSucursal, $Ubicacion, $NombreSucursal, $NombrePOS, $NombreBD, $Cantidad, $Version, $URL, $Bucket)
    {
        ...
        if(ConectorBD::ejecutarFila($sql)){
            ...
            $sql = "INSERT INTO TSucursal(IdSucursal, Ubicacion, NombreSucursal, NombrePOS, NombreBD, Cantidad, Version, URL, Bucket) VALUES ($IdSucursal, '$Ubicacion', '$NombreSucursal', '$NombrePOS', '$NombreBD', $Cantidad, '$Version', '$URL', '$Bucket')";
