...
<body>
<form class="square" id=CrearSucursal action="sucursal.php" method="post">
        ...
        <div id="NuevaSucursal">
            <table style="width:100%">
                ...
                <tr>
                    ...
                    <td><input name="$NombreSucursal" id="$NombreSucursal" type="text"></td>
                </tr>
                <th>Nombre del POS</th>
                <td><input name="$NombrePOS" id="$NombrePOS" type="text"></td>
                </tr>
                <th>Nombre de la BD</th>
                <td><input name="$NombreBD" id="$NombreBD" type="text"></td>
                </tr>
                <th>Cantidad de POS</th>
                <td><input name="$Cantidad" id="$Cantidad" type="text"></td>
                </tr>
                <th>Version del Sistema</th>
                <td><input name="$Version" id="$Version" type="text"></td>
                </tr>
                <th>URL de los respaldos</th>
                <td><input name="$URL" id="$URL" type="text"></td>
                </tr>
                <th>Bucket S3</th>
                <td><input name="$Bucket" id="$Bucket" type="text"></td>
                </tr>
                <tr>
                    <input name="idSucursal" type="hidden" value=''><br>
                    <input name="accion" type="hidden" value="agregar"><br>
